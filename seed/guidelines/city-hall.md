...
This is the Simulated Agent City Hub's own repository — the tool itself. Work carefully; changes here affect every other city.
...
- Keep the backend theme-agnostic: the "Simulated Agent City" theming lives in content and the frontend, not in core backend logic. Don't hard-code persona, city, or building names into backend code.
